...
public final class PermissionRequest {
    ...
    private final boolean mShowRationale;
    ...
    public static final class Builder {
        ...
        /**
         * @param showRationale show rationale or not
         * @see #setRationale(String)
         */
        @NonNull
        public Builder enableRationale(@Nullable boolean showRationale) {
            mShowRationale = showRationale;
            return this;
        }
