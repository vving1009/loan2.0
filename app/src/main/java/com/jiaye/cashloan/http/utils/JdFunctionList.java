...
public class JdFunctionList<T> implements Function<JdResponse<T>, List<T>> {

    @Override
    public List<T> apply(JdResponse<T> baseResponse) throws Exception {
        ...
        return baseResponse.getResult().getResultInner().getResult();
    }
}
